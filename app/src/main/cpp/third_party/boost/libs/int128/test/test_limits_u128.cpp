...
void test_member_functions()
{
    ...
    BOOST_INT128_IF_CONSTEXPR (builtin_max != 0)
    {
        ...
        BOOST_TEST(std::numeric_limits<builtin_u128>::epsilon() == std::numeric_limits<lib_u128>::epsilon());
        BOOST_TEST(std::numeric_limits<builtin_u128>::round_error() == std::numeric_limits<lib_u128>::round_error());
        BOOST_TEST(std::numeric_limits<builtin_u128>::infinity() == std::numeric_limits<lib_u128>::infinity());
        BOOST_TEST(std::numeric_limits<builtin_u128>::quiet_NaN() == std::numeric_limits<lib_u128>::quiet_NaN());
        BOOST_TEST(std::numeric_limits<builtin_u128>::signaling_NaN() == std::numeric_limits<lib_u128>::signaling_NaN());
        BOOST_TEST(std::numeric_limits<builtin_u128>::denorm_min() == std::numeric_limits<lib_u128>::denorm_min());
    }
}
