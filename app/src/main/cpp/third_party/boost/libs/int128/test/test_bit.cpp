...
void test_bit_width()
{
    BOOST_TEST_EQ(boost::int128::bit_width(boost::int128::uint128{0}), 0);
...
void test_bit_ceil()
{
    ...
    boost::int128::uint128 x {3};
    boost::int128::uint128 y {4};
...
void test_countl_one()
{
    ...
    boost::int128::uint128 x {UINT64_MAX, UINT64_MAX};
...
void test_countr_zero()
{
    ...
    boost::int128::uint128 x {0x8000000000000000ULL, 0};
...
void test_rotl()
{
    constexpr boost::int128::uint128 x {1};
    boost::int128::uint128 y {1};
...
void test_rotr()
{
    constexpr boost::int128::uint128 x {0x8000000000000000ULL, 0};
    boost::int128::uint128 y {0x8000000000000000ULL, 0};
...
void test_popcount()
{
    ...
    constexpr boost::int128::uint128 y {1};
...
void test_byteswap()
{
    // Test 1: Basic test with specific byte values
    {
        ...
        boost::int128::uint128 original{
            0x0123456789ABCDEFULL,
            0xFEDCBA9876543210ULL
        };

        // Expected result after byteswap
        boost::int128::uint128 expected{
